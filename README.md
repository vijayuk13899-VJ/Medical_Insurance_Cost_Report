...
The dataset contains no missing values, making it ideal for machine learning modelling. 1
...
Key insights:
    ...
    Strong correlations:
        ...
        Age → costs (~0.30)
    Interaction between BMI and smoking affects high costs 1
...
✅ XGBoost achieved the highest performance, explaining ~87% of variance in insurance costs. 1
🧠 Key Findings
